...
class Drinks extends Component {
    ...
    render() {
        ...
        let arrDefCoffee = [
            { id: 0, name: "Espresso", price: "25.20 zł", desc: "Espresso is made with an espresso machine where hot water is pressurized through tightly packed coffee grounds to create a concentrated coffee. One espresso shot is one ounce and is enjoyed in a small cup called a demitasse cup." },
            { id: 1, name: "Dopio", price: "35.80 zł", desc: "Doppio is two shots of espresso. It’s Italian for double. "},
            ...
            { id: 3, name: "Ristretto", price: "65.78 zł", desc: "The opposite of lungo, ristretto is an espresso with a shorter pull time, has less water and is more concentrated than espresso and the most concentrated coffee drink on this list. " },
            { id: 4, name: "Espresso con Panna", price: "115.78 zł", desc: "Espresso con panna is espresso with cream in Italian. The drink is just what its name suggests, a shot of espresso topped with whipped cream. " },
            ...
            { id: 12, name: "Breve", price: "36.78 zł", desc: "Breve is a shot of espresso with steamed half and half. The difference between a latte and breve is the half and half in a breve instead of milk found in a latte." },
            ...
            { id: 16, name: "Instant Coffee", price: "75.78 zł", desc: "You don’t need any special equipment to make instant coffee. Just dissolve the instant coffee granules into water and you have a cup of coffee." },
            { id: 17, name: "Frappuccino", price: "11.78 zł", desc: "A Frappuccino is Starbucks’ line of blended coffee, milk and ice beverages. There are various flavors and a ‘secret menu’ where customers can order flavors not on the menu and customize it into variations like different candy flavors and even a tie dye Frappuccino." },
            { id: 18, name: "Cold Brew", price: "25.78 zł", desc: "Cold brew coffee requires steeping freshly ground coffee in room temperature water for at least 12 hours. The coffee is never heated. Instead, time is required to brew the coffee." },
            { id: 19, name: "Nitro Cold Brew Coffee", price: "42.69 zł", desc:"Nitro coffee is cold brew coffee infused with nitrogen to create a drink similar to a stout beer with its layer of crema." },
